        ...
        return (
            <div className="Privacy row">
                <div className="column large-12">
                    <h1>dSite, DAO Privacy Policy</h1>
                    ...
                    <p className="c2">
                        <span>
                            This Privacy Policy describes how dSite collects,
                            uses and discloses information, and what choices you
                            have with respect to the information. This Policy
                            applies to the
                        </span>
                        <span>
                            &nbsp;dSite.io, dSite subdomains (e.g.,
                            signup.dsite.io) and services
                        </span>
                        <span className="c1">
                    ...
                    <p className="c2">
                        <span className="c1">
                            When we refer to &ldquo;dSite&rdquo;, we mean the
                            dSite entity that acts as the controller of your
                            information.
                        </span>
                    </p>
                    <p className="c2">
                    ...
                    <p className="c2">
                        <span className="c1">IP address;</span>
                    </p>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                        <span className="c1">Language information;</span>
                    </p>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    ...
                    <h3 className="c6">SHARING OF PERSONAL INFORMATION</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <h3 className="c6">INTERNATIONAL TRANSFER</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <h3 className="c6">HOW INFORMATION IS SECURED</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <h3 className="c6">INFORMATION CHOICES AND CHANGES</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <p className="c2">
                        <span>
                            ...
                            request to @dsiteprivacy. You can request to
                        ...
                        <span className="c8 c12">
                            <a
                                className="c5"
                                href="https://www.google.com/url?q=https://github.com/dsites/frontend%23get_user_data-username&amp;sa=D&amp;ust=1527292847102000"
                            >
                                here
                            </a>
                        </span>
                    ...
                    <h3 className="c6">ELIGIBILITY</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <h3 className="c6">NOTICE TO CALIFORNIA RESIDENTS</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c2">
                    ...
                    <h3 className="c6">NOTICE TO EU DATA SUBJECTS</h3>
                    <p className="c0">
                        <span className="c1" />
                    </p>
                    <p className="c0">
                    ...
                    <ul className="c16 lst-kix_5gmcovz1lhm4-0 start">
                        <li className="c2 c9">
                    ...
                    <p className="c2">
                        <span>
                            You can submit these requests via dSite to
                            @dpay-privacy. We may request specific
                            ...
                            @dsite-privacy or submit a complaint to the
