...
export default class UserProfile extends React.Component {
    ...
    render() {
        ...
        // let balance_dpay = parseFloat(account.balance.split(' ')[0]);
        // let vesting_dpay = vestingDPay(account, gprops).toFixed(2);
        // const dpay_balance_str = numberWithCommas(balance_dpay.toFixed(2)) + " BEX";
        // const power_balance_str = numberWithCommas(vesting_dpay) + " BEX POWER";
        // const bbd_balance = parseFloat(account.bbd_balance)
        // const bbd_balance_str = numberWithCommas('$' + bbd_balance.toFixed(2));
