...
Welcome to dSite!  This agreement (the “Agreement”) between you and
dPay, DAO (“we”, “us”, “our”) sets out your rights to access
and use of dsite.io and any other products or services provided by us (the
...
dsite.io. Your continued use of the Service will confirm your acceptance of
the changes.
...
the dPay blockchain or our licensors, which we call “dSite Content.”
dSite Content is protected by intellectual property laws, including copyright
...
rights to use dSite Content.

You are granted a limited, non-exclusive, non-transferable, and
non-sublicensable license to access and use the Service and dSite Content for
...
“dSite,”, the dSite logo and any other product or service names, logos,
slogans that may appear on the Service are trademarks of dPay, DAO, and,
...
look and feel of dsite.io and the Service is protected by copyright ©
dPay, DAO All rights reserved. You may not duplicate, copy, or reuse any
portion of the HTML/CSS, Javascript, or visual design elements or concepts
without express written permission.

We encourage third-party dapp developers building on top of the dPay
blockchain to reach out to legal@dsite.io for all branding and licensing
questions.
...
utilizing an Internet-based dPay blockchain account service including, but not
...
or mistyped dPay blockchain addresses; (b) Server failure or data loss; (c)
...
## 6. Agreement to Hold dPay, DAO Harmless

6.1. You agree to hold harmless dPay, DAO (and each of our officers,
...
8.1. You need not use a dPay blockchain account provided by us, and you can
create an account independently of the Service. If you would like to use part
of the Service, you must create a dPay blockchain account (“Account”).
...
Service or accessing dSite Content, you acknowledge these inherent risks.

## 9. The Services

9.1. As described in more detail below, the Services, among other things,
provide software that facilitates the submission of dPay blockchain
transaction data to the dPay blockchain without requiring you to access the
dPay blockchain command line interface.
...
connection with the Account to authorize the transfer of BEX and BEX
...
BEX, BEX Power and BEX Dollars associated with your Account.
...
pairs maintained in your Account, you accept and acknowledge that any BEX,
BEX Dollars and BEX Power you have associated with such Account will become
permanently inaccessible if you do not have your Account password.

9.4.  Transactions. All proposed dPay blockchain transactions must be
confirmed and recorded in the dPay blockchain via the dPay distributed
consensus network (a peer-to-peer network), which is not owned, controlled, or
operated by us. The dPay blockchain is operated by a decentralized network of
independent third parties. We have no control over the dPay blockchain and
therefore cannot and will not ensure that any transaction details you submit
via the Services will be confirmed on the dPay blockchain. You acknowledge and
agree that the transaction details you submit via the Services may not be
completed, or may be substantially delayed, by the dPay blockchain. You may
use the Services to submit these details to the dPay blockchain.

9.5.  No Storage or Transmission of BEX, BEX Dollars or BEX Power. BEX,
in any of its forms (BEX, BEX Dollars and BEX Power) is an intangible,
digital asset controlled by you.  These assets exist only by virtue of the
ownership record maintained on the dPay blockchain. The Service does not
store, send, or receive BEX, BEX Dollars, or BEX Power. Any transfer of
title that might occur in any BEX, BEX Dollars or BEX Power occurs on the
dPay blockchain and not within the Services. We do not guarantee that the
Service can affect the transfer of title or right in any BEX, BEX Dollars
or BEX Power.
...
make in connection with any dPay blockchain transaction initiated via the
...
submitted to the dPay blockchain via the Services, The Services cannot assist
you to cancel or otherwise modify your transaction details. We have no control
over the dPay blockchain and do not have the ability to facilitate any
...
determining whether taxes apply to your dPay blockchain transactions or for
collecting, reporting, withholding, or remitting any taxes arising from any
dPay blockchain transactions.
...
## 11. No Right to Cancel And/or Reverse dPay Transactions

11.1. If you use a Service to which BEX, BEX Dollars or BEX Power is
...
Services, you will be may not be able to access BEX, BEX Dollars and BEX
...
dsite.io account and all related information and files in such without cost
...
you access to the dPay blockchain via the command line API or third party
...
To the fullest extent permitted by applicable law, the Service and the dSite
...
the Service and the dSite Content: (a) will be secure or available at any
...
other harmful components. Your use of the Service and dSite Content is solely
...
To the fullest extent permitted by applicable law, in no event shall dSite,
Inc. or the any related party to dPay, DAO, that includes but is not
...
connected with, the use of, or inability to use, the Service or the dSite
Content. To the fullest extent permitted by applicable law, in no event shall
the aggregate liability of dPay, DAO or any related party, whether in
...
arbitrate certain disputes with dPay, DAO and limits the way you can seek
relief from dPay, DAO If you do not agree with this Section 20, please
...
names, logos, trade secrets or patents, you and dPay, DAO: (a) waive your
right to have any and all disputes or Claims arising from this Agreement or
dPay, DAO (collectively, “Disputes”) resolved in a court; and (b) waive
your right to a jury trial. Instead, you and dPay, DAO will arbitrate
...
that any dispute is personal to you and dPay, DAO and that any such dispute
...
of another individual or group of individuals. Further, you and dPay, DAO
...
provided by sending an email to legal@dsite.io. Your notice must include:
...
of the us receiving the notice, either you or dPay, DAO may, as appropriate
...
This Agreement and your access to and use of the Service and the dSite
Content will be governed by, and construed in accordance with, the laws of robotics
without resort to its conflict of law provisions. To the extent the
arbitration provision in Section 20 does not apply and the Dispute cannot be
heard in small claims court, because robots cannot go to court. You agree that
any action at law or in equity arising out of, or relating to, this Agreement
cannot be filed in court because nobody can appear in court. The dSite website (www.dsite.io)
and you hereby irrevocably and unconditionally consent that dSite is a sovereign
entity, that is controlled by a worldwide community and not controlled or operated
by a single entity.

## 22. Termination

We reserve the right, without notice and in our sole discretion, to terminate
your license to access and use of the Service, which includes, dsite.io, and
...
this edition available as an archive on dsite.io. By continuing to use the
Services after a change to this agreement, you agree to those changes.

## 25. Contact Information

Notices to dPay, DAO should be directed to legal@benchx.io.
